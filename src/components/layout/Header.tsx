...
import { UserNotificationModal, MobileMenuModal } from '@/components/layout'
...
export const EmploymentFormsHeader: React.FunctionComponent = () => {
  ...
  const {
    isModalOpen: isMobileMenuModalOpen,
  ...
  return (
    <>
      ...
      <MobileMenuModal
        isMobileMenuModalOpen={isMobileMenuModalOpen}
      ...
      <header id="header">
        <div className="flex w-full items-center  md:hidden">
          <button className="block sm:hidden" onClick={openMobileMenuModal}>
            <svg
              width="30px"
              height="30px"
              viewBox="0 0 30 30"
        ...
        <a href="#" className="brand hidden md:block">
          {/* 
                    <!-- june image logo section --> */}
          <div className="h-[57px] w-[168px] bg-[url('/images/logo.png')] bg-cover bg-center bg-no-repeat"></div>
          {/* <!-- june image logo section --> */}
        ...
        <div>
          <div className="menu">
            ...
            <div className="link_container hidden md:flex md:items-center">
              <Link href="/">
                <a>HOME</a>
              </Link>
              <Link href="#services">
      ...
      <style jsx>{`
        ...
        .navbar .attr-nav .side-menu .bar-1 {
          position: absolute;
          right: 0;
          top: 0;
          content: '';
        ...
        .navbar .attr-nav .side-menu .bar-2 {
          top: 8px;
          width: 35px;
        }
        .navbar .attr-nav .side-menu .bar-1 {
        ...
        .navbar .attr-nav .side-menu .bar-3 {
          top: 16px;
          width: 30px;
        }
        .navbar .attr-nav .side-menu .bar-1 {
